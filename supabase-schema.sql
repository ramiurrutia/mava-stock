create table if not exists public.mava_admin_store (
  ...
  stock_quantities jsonb not null default '{}'::jsonb,
...
alter table public.mava_admin_store
  add column if not exists stock_quantities jsonb not null default '{}'::jsonb;
